                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown ps-2">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="{{route('diciplinas.index')}}" class="dropdown-item">Diciplinas</a></li>
                                <li><a href="{{route('docencia.index')}}" class="dropdown-item">Docencia</a></li>
                                <li><a href="{{route('alunos.index')}}" class="dropdown-item">Aluno</a></li>
                                <li><a href="{{route('matriculas.index')}}" class="dropdown-item">Matricula</a></li>
                            </ul>
                        </li>
