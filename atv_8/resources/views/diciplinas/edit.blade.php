...
@extends('templates.main', ['titulo' => "Alterar Diciplinas"])
<!-- Preenche o conteúdo da seção "titulo" -->
@section('titulo') Diciplinas @endsection
<!-- Preenche o conteúdo da seção "conteudo" -->
@section('conteudo')

<form action="{{ route('diciplinas.update', $dados->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col" >
            <div class="form-floating mb-3">
                ...
                @endif
                <label for="nome">Nome da Diciplina:</label>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col">
            <a href="{{route('diciplinas.index')}}" class="btn btn-secondary btn-block align-content-center">
