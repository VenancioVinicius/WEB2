...
@section('conteudo')
    ...
    <form action="{{ route('cursos.store') }}" method="POST">
        ...
        <div class="row">
            <div class="col" >
                <div class="form-floating mb-3">
                    <select name="eixo_nome" class="form-control {{ $errors->has('eixo_nome') ? 'is-invalid' : '' }}">
                    ...
                    @if($errors->has('eixo_nome'))
                        <div class='invalid-feedback'>
                            {{ $errors->first('eixo_nome') }}
                        </div>
                    @endif
                    <label for="eixo_nome">Eixo do Curso</label>
                </div>
            </div>
        </div>
        <div class="row">
