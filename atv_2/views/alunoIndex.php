...
<html lang="pt-br">
    <head>
        ...
        <title>SisColetivos - Alunos</title>
    ...
    <div class="container py-4">    
        <form action="alunoIndex.php" method="POST">
            <input type="hidden" name="form_submit" value="OK">
            <div class="row">
                <div class="col">
                    <h3 class="display-7 text-secondary"><b>Alunos</b></h3>
                </div>
