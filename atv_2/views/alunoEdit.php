...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container py-4">        
            <form class="form" method="post" action="alunoEdit.php">
                <input type="hidden" name="form_submit" value="OK">

                <h3 class="display-7 text-secondary"><b>Alterar Dados Aluno</b></h3>
                <div class="row">
                    <div class="col" >
                ...
                <div class="row">
                    <div class="col">
                        <a href="alunoIndex.php" class="btn btn-secondary btn-block align-content-center">
