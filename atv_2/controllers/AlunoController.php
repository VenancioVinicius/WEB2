<?php
	...
	class AlunoController {
		...
		public static function index() {
			echo "<script>window.location='../views/alunoIndex.php'</script>";
		}
		...
		public static function create() {
            echo "<script>window.location='../views/alunoCreate.php'</script>";
        }
		...
		public static function edit($id) {
			...
			if(!empty($aluno)) {
				...
				$url = "../views/alunoEdit.php?id=$aluno->id";
                $url .= "&nome=$aluno->nome";
                $url .= "&telefone=$aluno->telefone";
                $url .= "&endereco=$aluno->endereco";
